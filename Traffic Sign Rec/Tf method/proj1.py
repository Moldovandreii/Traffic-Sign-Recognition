# -*- coding: utf-8 -*-
"""
Created on Fri May 15 19:04:57 2020
...
#ROOT_PATH = "/r"
#train_data_dir = os.path.join(ROOT_PATH, "Proj1/Training")
train_data_dir = r"C:\Users\Andrei\Desktop\Proj1\Training"
test_data_dir = r"C:\Users\Andrei\Desktop\Proj1\Testing"
...
#use lrelu instead of relu in order to remove possible blocks
def lrelu(x):
...
#2nd method using convolutional layers
...
with graph.as_default():
    ...
    logits = tf.contrib.layers.fully_connected(flat, 62, lrelu)
